#!/bin/bash
#SBATCH --job-name=pm_gpt2_ppm
#SBATCH --output=/home/20201100/sem-repl/logs/pm_gpt2_%A_%a.out
#SBATCH --error=/home/20201100/sem-repl/logs/pm_gpt2_%A_%a.err
...
mkdir -p /home/20201100/sem-repl/logs/pm-gpt2
...
PARAMS_FILE="/home/20201100/sem-repl/scripts/pm-gpt2_params.txt"
