#!/bin/bash
#SBATCH --job-name=llama_ppm
#SBATCH --output=/home/20201100/sem-repl/logs/llama_%A_%a.out
#SBATCH --error=/home/20201100/sem-repl/logs/llama_%A_%a.err
...
PARAMS_FILE="/home/20201100/sem-repl/scripts/llama_params.txt"
