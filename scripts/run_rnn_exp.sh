#!/bin/bash
#SBATCH --job-name=rnn_ppm
#SBATCH --output=/home/20201100/sem-repl/logs/rnn_%A_%a.out
#SBATCH --error=/home/20201100/sem-repl/logs/rnn_%A_%a.err
...
PARAMS_FILE="/home/20201100/sem-repl/scripts/rnn_params.txt"
